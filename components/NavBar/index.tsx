...
type NavItems = 'Projects' | 'Skills' | 'About' | 'Contact';

const navItems: NavItems[] = ['About', 'Skills', 'Projects', 'Contact'];
                    ...
                    <Box sx={{display: {xs: 'none', sm: 'block'}}}>
                        {navItems.map((item) => (
                            <Button key={item} sx={{color: '#fff'}}>
                                <Link color="inherit" href={`#${item}`} style={{color: colorTypographyDark}}>
                                    {item}
                                </Link>
